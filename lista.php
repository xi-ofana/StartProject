...
<?php
  ...
  <li class='media'>
    <img class='mr-3' src='logotipos/$dados[logotipo]' width='150px' height='140px' alt='logo'>
	<div class='media-body'>
      <h5 class='mt-0 mb-1'>$dados[nome]</h5>
	  $dados[descricao]
	 <p> <p> <p> <p> <a href='detalhes.php?startup=$dados[id_startup]' class='btn btn-primary'>Visitar</a> </p> </p> </p> </p>
	 <br> <br> <br>
	 </div>
