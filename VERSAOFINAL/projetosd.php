...
<div class='col-6'>
  ...
  <p><b>Nome do projeto: </b>$dados[nomeproj]</p>		
	<p><b>Autor: </b>$dados[autor]</p>
	<p><b>Descrição: </b>$dados[descproj]</p>
  <p><b>E-mail:</b> $dados[emailp]</p>
	<p><b>Telefone: </b>$dados[telefonep]</p>	
...
<p class="text-center"><a href="listaproj.php" class='btn btn-danger'>Voltar</a>
</p>
</div>
</div>
<hr>
