...
<?php
  ...
  $query="SELECT idprojeto, nomeproj, descproj, autor FROM projetos ORDER BY nomeproj ASC";
  //echo $query;exit;
		...
		echo "
			<div class='row mb-5 mr-2 ml-3 p-5 m-lg-5 m-xl-5 m-sm-5 p-lg-5 p-xl-5 p-sm-5 ' style='background-color: white;'>
				...
				<div class='col-12 col-lg col-xl col-sm'>
					<h5 class=' display-4 mb-4' style='font-size: 45px; color: #378fac'>$dados[nomeproj]
					</h5>
					<div class='d-flex'>
					
					<br>
				  		<p class='text-muted'>$dados[autor]</p>
	  						<p class='text-muted'>/</p>
							  
					</div>
					<hr>
					
					<p class='text'> $dados[descproj]</p>
					
					<p> <p> <p> <p> 
					<hr>
					<a href='projetosd.php?projeto=$dados[idprojeto]' class='btn btn-entrar mt-1'>Conhecer</a> </p> </p> </p> </p>
